...
私が同僚と[フィーチャーブランチ]({% post_url 2009-09-03-FeatureBranch %})について話しているのを聴いた人は、我々があのパターンの大ファンではないということを知っている。
...
その最初のひとつが、[自己テストコード]({% post_url 2014-05-01-SelfTestingCode %})だ。テストは、我々のコードについて、テストから見た視点でのコードのあるべき意味と、実際のコードとの間に、整合性がとれているかを有効にチェックしてくれる。
