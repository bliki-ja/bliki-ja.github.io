...
> モデルが段階的に進化し、目に見えない能力の境界線を越え、これまでに解決が困難だった多くのコーディング課題がいきなり解決可能になった瞬間
...
> 2025年下旬、私は最後のコードを書き上げた。そのときは気づいていなかったが、それが40年間のプログラミング経験の転換点だった。その後もコードを書いたりリリースしたりしているが、これまでとは決定的な違いがある。それは、コードを自分で書いていないことだ。私が指示を出したAIエージェントが書いている。
